...
async function initDB() {
  ...
  if (parseInt(productsExist[0].count) === 0) {
    await sql`
      ...
      ('Midnight Oud', 'Maison Noir', 'A deep, smoky oud with notes of dark amber, sandalwood, and a touch of leather. Mysterious and captivating.', 1850000, 25, 'https://images.unsplash.com/photo-1541643600914-78b084683702?w=500', 'Oriental', 50),
      ...
      ('Santal Mystique', 'Nomade', 'Silky Australian sandalwood layered with iris, creamy musk, and a hint of cardamom. Skin-close and intimate.', 2100000, 15, 'https://images.unsplash.com/photo-1568702846914-96b305d2aaeb?w=500', 'Woody', 50),
      ...
      ('Arctic Musk', 'Glacé', 'Clean, powdery musk with hints of white cedar and soft cotton. Pure and skin-like.', 890000, 45, 'https://images.unsplash.com/photo-1491553895911-0055eca6402d?w=500', 'Musk', 100)
    `;
